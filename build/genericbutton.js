...
function EditComponent(props) {
  ...
  const currentColorValue = _inc_ourColors__WEBPACK_IMPORTED_MODULE_1__.ourColors.filter(color => {
    return color.name == props.attributes.colorName;
  })[0].color;
  function handleColorChange(colorCode) {
    const {
      name
    } = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.getColorObjectByColorValue)(_inc_ourColors__WEBPACK_IMPORTED_MODULE_1__.ourColors, colorCode);
    props.setAttributes({
      colorName: name
    });
  }
  function handleBorderColorChange(color) {
    const {
      name
    } = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.getColorObjectByColorValue)(_inc_ourColors__WEBPACK_IMPORTED_MODULE_1__.borderColors, color);
    props.setAttributes({
      borderColor: name
    });
  }
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.BlockControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarGroup, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.ToolbarButton, {
    ...
    clearable: false,
    colors: _inc_ourColors__WEBPACK_IMPORTED_MODULE_1__.ourColors,
    ...
    disableCustomColors: true,
    clearable: false,
    colors: _inc_ourColors__WEBPACK_IMPORTED_MODULE_1__.borderColors,
    ...
    allowedFormats: [],
    tagName: "a",
    className: `btn border--${props.attributes.borderColor} btn--${props.attributes.colorName}`,
...
function SaveComponent(props) {
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    className: ` btn  btn--${props.attributes.colorName} border--${props.attributes.borderColor}`
